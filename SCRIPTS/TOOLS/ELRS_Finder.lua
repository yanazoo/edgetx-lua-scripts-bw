-- ELRS_Finder.lua  (EdgeTX – Boxer B/W + TX15 MAX / TX16S Mark II / Jumper T14)
...
local H        = LCD_H or 64
local IS_LARGE = (W >= 320)   -- TX15 MAX / TX16S Mark II / Jumper T14 = 480×272 ; Boxer = 128×64
...
local function run_func(event)
  ...
  if IS_LARGE then
    --------------------------------------------------------------------------
    -- TX15 MAX / TX16S Mark II / Jumper T14  480×272
